...
<table align="center" border="0" cellpadding="0" cellspacing="0" id="bodyTable" style="width: 90%; max-width: 600px; border-collapse: collapse;mso-table-lspace: 0pt;mso-table-rspace: 0pt;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;height: 100%;margin: 0 auto;padding: 0;">
    <tr>
        <td align="center" valign="top" id="bodyCell" style="mso-line-height-rule: exactly;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;height: 100%;margin: 0;padding: 0;width: 100%;">
            <!-- BEGIN TEMPLATE // -->
            <table border="0" cellpadding="0" align="center" cellspacing="0" width="100%" style="border-collapse: collapse;mso-table-lspace: 0pt;mso-table-rspace: 0pt;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;">
                <tr>
<td align="center" valign="top" id="templateHeader" data-template-container="" style="background:rgba(51, 51, 51, 0.3) no-repeat center/cover;mso-line-height-rule: exactly;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;background-color: rgba(51, 51, 51, 0.3);background-repeat: no-repeat;background-position: center;background-size: cover;border-top: 0;border-bottom: 0;padding-top: 5px;padding-bottom: 5px;">
                        <!--[if (gte mso 9)|(IE)]>
                                            ...
                                            <table class="mcnImageContentContainer" style="min-width: 100%;border-collapse: collapse;mso-table-lspace: 0pt;mso-table-rspace: 0pt;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;" width="100%" cellspacing="0" cellpadding="0" border="0" align="left">
                                                <tbody><tr>
                                                    <td class="mcnImageContent" style="padding-right: 9px;padding-left: 9px;padding-top: 0;padding-bottom: 0;text-align: center;mso-line-height-rule: exactly;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;" valign="top">
                                                        ...
                                                        <img alt="" src="http://landlagos.com/img/logo2.png" style="max-width: 400px;padding-bottom: 0;display: inline !important;vertical-align: bottom;border: 0;height: auto;outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;" class="mcnImage" width="500" align="middle">
                                            ...
                                            <table style="max-width: 100%;min-width: 100%;border-collapse: collapse;mso-table-lspace: 0pt;mso-table-rspace: 0pt;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;" class="mcnTextContentContainer" width="100%" cellspacing="0" cellpadding="0" border="0" align="left">
                                                <tbody><tr>
                                                    ...
                                                    <td class="mcnTextContent" style="padding-top: 0;padding-right: 18px;padding-bottom: 9px;padding-left: 18px;mso-line-height-rule: exactly;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;word-break: break-word;color: #808080;font-family: Helvetica;font-size: 16px;line-height: 150%;text-align: left;" valign="top">
                                                        <h5>Dear {{ $request->name}}</h5>

                                                        <p>
                                                            Welcome to LandLagos, we are a real estate company committed to the control and reversal of the unfair and
                                                             unrealistic inflation of real estate in Lagos state and by so doing, make property ownership practical.
                                                        </p>
                                                        <p>
                                                            With our affordable rates, flexible payment plan, and fixed return rates designed to control market forces, we make it
                                                             possible for you to either own your own home or make a profit selling landed property bought from us at a 30% return on 
                                                             capital in the first year, 25% in the second year and 15% return on capital subsequently. Whichever your interest, we are here for you. 
                                                        </p>
                                                        <p>
                                                            A partner relations manager will reach out to you to verify your interest, and make arrangement to have you visit our office for a proper 
                                                            briefing on our offerings and discuss the plan you choose.


                                                        </p>
                                                        <p>
                                                            Please contact this number, should you have any questions +2348154403060 .
                                                        </p>
                                                        <p>
                                                            Thank you for your interest in LandLagos .
                                                        </p>
                                                        ...
                                                        <p style="margin-top: 25px;">
                                                            Warm Regards, <br>
                                                            Glory Osei, <br>
                                                            Co-Founder & CEO, LandLagos. <br>
                                                            <img src="http://landlagos.com/img/logo2.png" alt="logo" style="width: 20%">
                                                        </p>

                                                        <!-- <p style="text-align: center">
                                                            <span>Download attachments: </span>
                                                            <a href="https://78306-229696-raikfcquaxqncofqfm.stackpathdns.com/pdf/PARTNERSHIP CONTRACT.pdf">Partnership Contract</a>
                                                            <span> | </span>
                                                            <a href="https://78306-229696-raikfcquaxqncofqfm.stackpathdns.com/pdf/PARTNERSHIP FORM.pdf">Partnership Form</a>
                                                        </p> -->
                                                    </td>
                                                </tr>
                                                </tbody></table>
                                            ...
                                            <table style="max-width: 100%;min-width: 100%;border-collapse: collapse;mso-table-lspace: 0pt;mso-table-rspace: 0pt;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;" class="mcnTextContentContainer" width="100%" cellspacing="0" cellpadding="0" border="0" align="left">
                                                <tbody><tr>
                                                    ...
                                                    <td class="mcnTextContent" style="padding-top: 0;padding-right: 18px;padding-bottom: 9px;padding-left: 18px;mso-line-height-rule: exactly;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;word-break: break-word;color: #FFFFFF;font-family: Helvetica;font-size: 12px;line-height: 150%;text-align: center;" valign="top">
                                                        ...
                                                        <p>
                                                            <a href="https://landlagos.com">www.landlagos.com</a> <span> | </span>
                                                            <span>info@landlagos.com</span> <br>

                                                            <span>Instagram: <a href="https://www.instagram.com/landlagos">@landlagos</a></span> <br>
                                                            <span>Facebook: <a href="https://www.facebook.com/landlagos">LandLagos</a></span> <br>
                                                            <span>Call: 08154403010 | 08154403060</span>
                                                        </p>

                                                        <em>Copyright © LandLagos Company, All rights reserved.</em><br>
                                                        <br>
                                                        This email was sent to {{$request->name}}<br>
                                                        You can <a href="*|UNSUB|*" style="mso-line-height-rule: exactly;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;color: #FFFFFF;font-weight: normal;text-decoration: underline;">unsubscribe from receiving this email</a>. If it is not yours.<br>
